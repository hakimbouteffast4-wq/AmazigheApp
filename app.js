/**
 * AMAWAL ULTIMATE - Supabase Cloud Integrated (v2.1)
 */

// 1. Supabase Configuration
const supabaseUrl = 'https://savnjahwekgfnvcpofqe.supabase.co';
// يرجى وضع المفتاح (Anon Key) هنا ليعمل الربط السحابي بالكامل
...
} catch (e) { console.error("Supabase connection failed."); }
...
// 2. Repository with Local Fallback
...
function toggleSidebar() {
    ...
    if (s && o) { s.classList.toggle('active'); o.classList.toggle('active'); document.body.style.overflow = s.classList.contains('active') ? 'hidden' : 'auto'; }
}
